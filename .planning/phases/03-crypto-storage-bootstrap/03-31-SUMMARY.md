...
Only the four external delivery checks remain open: push the corrective commit, and obtain passing synthetic-merge Backend/portable, real-service and Web jobs. Phase 03 is not complete until those TODO rows are checked and the physical `- [ ]` query is empty.
