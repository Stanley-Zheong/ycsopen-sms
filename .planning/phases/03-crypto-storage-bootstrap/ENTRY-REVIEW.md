...
| ENTRY-03-12-COMPLETE-GATE | PASS | Transcripts 01-10 bind clean subject `f3749bd41b37f622b2f809ee2af8f2a2e6ff4218`, independent boundary, live dependency, exact-four trace, 30-plan graph, service identities, truthful open prerequisite, schema, matrix and TODO state. | Run `/usr/bin/env ruby .planning/tools/validate-phase-entry.rb --phase 03 --package crypto-storage-bootstrap --obligations .planning/PRD-OBLIGATIONS.md --entry-review .planning/phases/03-crypto-storage-bootstrap/ENTRY-REVIEW.md --entry-evidence .planning/phases/03-crypto-storage-bootstrap/ENTRY-EVIDENCE.md`; retain PASS only for exit zero and `plans=30`. |
