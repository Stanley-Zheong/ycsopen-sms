...
live review reopened retry-reason immutability and synchronous pre-pending
dismissal, so a newer pull-request head must repeat the authoritative gate before
merge.
